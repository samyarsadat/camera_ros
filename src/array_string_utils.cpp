...
template std::string encode_2d_numeric_array<int>(const std::vector<std::vector<int>> &array);
template std::string encode_2d_numeric_array<float>(const std::vector<std::vector<float>> &array);
template std::string encode_2d_numeric_array<double>(const std::vector<std::vector<double>> &array);
template std::vector<std::vector<int>> decode_2d_numeric_array<int>(std::string_view array_str);
template std::vector<std::vector<float>> decode_2d_numeric_array<float>(std::string_view array_str);
template std::vector<std::vector<double>> decode_2d_numeric_array<double>(std::string_view array_str);